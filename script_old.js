const API_URL =
  "https://script.google.com/macros/s/AKfycbzXQFFma12xGxCZ1RXjNSjjt-OEF_CAXtn_bDYvnMhFu97Ge76znBGPxcKHKPBV2y0e/exec";
...
async function carregarDadesInicials() {
  ...
  try {
    ...
    select.innerHTML =
      '<option value="">Error en connectar amb el servidor</option>';
  }
}
